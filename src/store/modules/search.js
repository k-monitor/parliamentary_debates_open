...
export const CHANGE_TYPE_FILTER = "search/CHANGE_TYPE_FILTER";
  ...
  switch (action.type) {
    case SEARCH_TERM:
      return {
        ...
        type_filter: action.search.type_filter,
    ...
    case SEARCH_SUCCESS:
      return {
        ...
        types: {
          ...action.results.aggregations.types.buckets,
        },
      };
